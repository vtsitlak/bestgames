...
gulp.task('scripts', function() {
    return series(
            ...
            gulp.src(config.bowerDir + 'angular-metatags/angular-metatags-module/angular-metatags.js'),
            gulp.src(config.bowerDir + 'angular-rating/src/angular-rating.js'),
            gulp.src(config.bowerDir + 'angular-sanitize/angular-sanitize.js'),
            gulp.src(config.bowerDir + 'bootstrap/dist/js/bootstrap.js'),
            gulp.src(config.bowerDir + 'angular-bootstrap/ui-bootstrap.js'),
            gulp.src(config.bowerDir + 'angular-bootstrap/ui-bootstrap-tpls.js'),
...
gulp.task('css', function() {
    return series(
            gulp.src(config.bowerDir + 'angular-bootstrap/ui-bootstrap-csp.css'),
            gulp.src(config.bowerDir + 'angular-bootstrap/ui-bootstrap-tpls.css'),
...
// Default Task
gulp.task('default', ['bower', 'fonts', 'htaccess', 'html', 'img', 'json', 'scripts', 'less', 'css', 'watch']);